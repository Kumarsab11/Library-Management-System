export function genenerateVerificationOtpEmailTemplate(otpCode) {
  return `<div
    ...
    <p style="font-size: 16px; color: #ccc;">To complete your registrationor login, please use the following
        verification code:</p>
    ...
    <footer style="margin-top: 20px; text-align: center; font-size: 14px; color: #666;">
        <p>Thank You,<br>BookVault Team</p>
...
export function generateForgotPasswordEmailTemplate(resetPasswordUrl) {
  return `<div
    ...
    <p style="font-size: 16px; color: #ccc;">Dear User,</p>
    <p style="font-size: 16px; color: #ccc;">Tou requested to reset your password. please click the button below to
        proceed:</p>
    <div style="text-align: center; margin: 20px 0;">
    ...
    <p style="font-size: 16px; color: #ccc;">If you did not request a password reset, please ignore this email. The link
        will expire in 10 minutes.</p>
    <p style="font-size: 16px; color: #ccc;">If the button above doesn't work, copy and paste the following URL into
        your browser:</p>
